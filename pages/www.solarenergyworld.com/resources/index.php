...
<head>
	...
	<style id='wmx-modals-wmx-modal-wrapper-style-inline-css' type='text/css'>
		.wp-block-wmx-modals-wmx-modal-wrapper {
			position: relative
		}

		.wp-block-wmx-modals-wmx-modal-wrapper.is-dark {
			color: #fff
		}

		.wp-block-wmx-modals-wmx-modal-wrapper.is-light {
			color: inherit
		}

		.wp-block-wmx-modals-wmx-modal-wrapper .inner-content-wrapper {
			overflow: hidden;
		...
		.wp-block-wmx-modals-wmx-modal-wrapper .toggle {
		...
		.wp-block-wmx-modals-wmx-modal-wrapper .toggle svg {
			height: 16px !important;
			transform: rotate(0deg);
			transition: transform .25s ease-in-out .05s;
			width: 16px !important
		}

		.wp-block-wmx-modals-wmx-modal-wrapper p {
			margin: 0
		}

		.wp-block-wmx-modals-wmx-modal-wrapper p:not(:last-child) {
			margin-bottom: 1em
		}
	</style>
